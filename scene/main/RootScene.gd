...
const SIGNAL_BIND := [
	...
	[
		...
		NodeTag.DUNGEON, NodeTag.SCHEDULE,
	],
	[
		SignalTag.GAME_OVER, NodeTag.END_GAME,
		NodeTag.END_GAME,
		NodeTag.SCHEDULE, NodeTag.PLAYER_INPUT,
		NodeTag.SIDEBAR_GUI,
	],
	[
	...
	[
		...
		NodeTag.PLAYER_INPUT, NodeTag.CREATE_OBJECT,
		NodeTag.SIDEBAR_GUI, NodeTag.HELP_INPUT,
		NodeTag.HELP_GUI, NodeTag.DEBUG_GUI, NodeTag.DEBUG_INPUT,
	],
	[
...
const NODE_REF := [
	[
		...
		NodeTag.DUNGEON,
		NodeTag.PLAYER_INPUT, NodeTag.REMOVE_OBJECT,
		NodeTag.ACTOR_ACTION, NodeTag.PROGRESS,
		NodeTag.CREATE_OBJECT, NodeTag.INIT_WORLD,
	],
	[
	...
	[
		...
		NodeTag.END_GAME,
		NodeTag.ACTOR_ACTION, NodeTag.PLAYER_INPUT,
		NodeTag.PROGRESS,
	],
	[
		NodeTag.REF_CREATE_OBJECT,
		NodeTag.CREATE_OBJECT,
		NodeTag.INIT_WORLD, NodeTag.PROGRESS,
		NodeTag.ACTOR_ACTION, NodeTag.PLAYER_INPUT,
	],
	[
		NodeTag.REF_SETTING,
	...
	[
		NodeTag.REF_SWITCH_SCREEN,
		NodeTag.SWITCH_SCREEN,
		NodeTag.PLAYER_INPUT, NodeTag.HELP_INPUT,
		NodeTag.DEBUG_INPUT,
	],
	[
		NodeTag.REF_HELP_GUI,
		NodeTag.HELP_GUI,
		NodeTag.HELP_INPUT,
	],
	[
		NodeTag.REF_PALETTE,
		NodeTag.PALETTE,
		NodeTag.PLAYER_INPUT, NodeTag.SIDEBAR_GUI,
		NodeTag.CREATE_OBJECT, NodeTag.HELP_GUI,
		NodeTag.ACTOR_ACTION, NodeTag.PROGRESS,
		NodeTag.DEBUG_GUI,
	],
]
